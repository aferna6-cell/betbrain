 ...
 * Validates American → Decimal conversion for the toggle feature.
 */

import { describe, it, expect } from 'vitest'
import { americanToDecimal } from '@/lib/odds'

// Reproduce the formatPrice logic from the provider
function formatPrice(american: number | null, format: 'american' | 'decimal'): string {
